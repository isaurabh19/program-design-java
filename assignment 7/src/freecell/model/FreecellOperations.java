...
public interface FreecellOperations<K> {
   ...
   * <pre>
   * F1:[b]f11,[b]f12,[b],...,[b]f1n1[n] (CardsImpl in foundation pile 1 in order)
   * F2:[b]f21,[b]f22,[b],...,[b]f2n2[n] (CardsImpl in foundation pile 2 in order)
   * ...
   * Fm:[b]fm1,[b]fm2,[b],...,[b]fmnm[n] (CardsImpl in foundation pile m in
   * order)
   * O1:[b]o11[n] (CardsImpl in open pile 1)
   * O2:[b]o21[n] (CardsImpl in open pile 2)
   * ...
   * Ok:[b]ok1[n] (CardsImpl in open pile k)
   * C1:[b]c11,[b]c12,[b]...,[b]c1p1[n] (CardsImpl in cascade pile 1 in order)
   * C2:[b]c21,[b]c22,[b]...,[b]c2p2[n] (CardsImpl in cascade pile 2 in order)
   * ...
   * Cs:[b]cs1,[b]cs2,[b]...,[b]csps (CardsImpl in cascade pile s in order)
   *
