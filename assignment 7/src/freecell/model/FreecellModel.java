 ...
 * class. A game can be played by getting a deck, starting the game and making valid moves. The game
 * is started by allocating a valid deck of cards among the cascade piles in a round robin
...
public class FreecellModel extends AbstractFreecellModel implements FreecellOperations<Cards> {
  ...
  protected Pile getCascadePile(int cascadeSize, List<Cards> deck) {
    return new CascadePile(cascadeSize, deck);
  }
   ...
   * exception.
   */
  public static class FreecellOperationsBuilderImpl extends AbstractFreecellOperationsBuilder
