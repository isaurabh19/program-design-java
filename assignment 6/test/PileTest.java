...
public class PileTest {
  ...
  public void testGetPileState() {
    assertEquals(emptyFoundationString.toString(), foundationPiletest.getPileState());
    assertEquals(initialCascadeString.toString(), cascadePileTest.getPileState());
    assertEquals(initialOpenString.toString(), openPileTest.getPileState());
  }
  ...
  public void testMoveFrom() {
    ...
    assertEquals(finalFoundationString.toString(), foundationPiletest.getPileState());
    assertEquals(emptyCascadeString.toString(), cascadePileTest.getPileState());
    assertEquals(initialOpenString.toString(), openPileTest.getPileState());
  }
