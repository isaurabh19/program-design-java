 ...
 * cost_basis[space][portfolio name]. The cost basis of portfolio is the total buying cost of its
 * composition. It will ask to re-enter the command if incorrect portfolio name is passed.
 */
public class CostBasis implements TradeCommand {
  ...
  public void execute(IPortfolioManagerModel model) throws IOException {
    ...
    double costBasis = model.getPortfolioCostBasis(portfolio);
