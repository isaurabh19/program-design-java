 ...
 * portfolio on that date. The syntax for the command is: current_value[space][portfolio name] and
 * date as prompted individually in year, month and day format.
 */
...
public class CurrentValue implements TradeCommand {
  ...
  public void execute(IPortfolioManagerModel model) throws IOException {
    ...
    LocalDateTime date = DateHelper.getDateTime(view, false);
